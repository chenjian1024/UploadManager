...
//        var eventMonitor: EventMonitor?
    ...
    extension GYSessionDelegate: URLSessionDelegate {
...
//            stateProvider?.cancelRequestsForSessionInvalidation(with: error)
    ...
    extension GYSessionDelegate: URLSessionTaskDelegate {
...
//                fatalError("dataTask received data for incorrect AFRequest subclass: \(String(describing: stateProvider?.request(for: dataTask)))")
//            }
//
...
//            }
    ...
    extension GYSessionDelegate: URLSessionDownloadDelegate {
        open func urlSession(_ session: URLSession,
